...
def get_fr_measurements_folder():
    """Returns the path to the Speaker Measurements folder in Documents"""
    return os.path.join(os.path.expanduser("~"), "Documents", "Speaker Measurements")
...
def load_from_txt(file_name):
    """Loads frequency response data from a .txt file in the Speaker Measurements folder."""
...
def response_suggestions(response_data):
